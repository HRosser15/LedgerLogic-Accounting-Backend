...
//
//                    this.accountService.upsert(accountToUpdate);
//
//                    EventLog accountEventLog = new EventLog("Update Account", accountToUpdate.getAccountId(),
//                            journal.getCreatedBy().getUserId(), LocalDateTime.now(),
//                            accountToUpdate.toString(), previousAccountState.toString());
//                    this.eventLogService.saveEventLog(accountEventLog);
//                }
//
